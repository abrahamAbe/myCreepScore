          ...
          <div className="championPortraitContainer" key={champion.championId}>
            <div className={champion.activeChampion ? '' : 'championContentDisabled'}>
              <Link to={'/champion/' + champion.championId}>
                <img onClick={this.setSelectedChampionData.bind(this, champion)} className='thumb-md championImage' src={'http://ddragon.leagueoflegends.com/cdn/7.8.1/img/champion/' + champion.championName + '.png'} />
              </Link>
            </div>
          </div>
        )
    ...
    return (
      <div className='homeMainContainer container'>
        ...
        <div className={this.state.showChampions ? 'hidden' : 'summonerInfoContainer'}>
          <img className="summonerInfoIcon" src={'http://ddragon.leagueoflegends.com/cdn/7.8.1/img/profileicon/' + this.state.profileIconId + '.png'} />
