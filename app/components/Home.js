          ...
          <div className="championPortraitContainer" key={champion.championId}>
            <div className={champion.activeChampion ? '' : 'championContentDisabled'}>
              <Link to={'/champion/' + champion.championId}>
                <img onClick={this.setSelectedChampionData.bind(this, champion)} className='thumb-md championImage' src={'http://ddragon.leagueoflegends.com/cdn/6.16.2/img/champion/' + champion.championName + '.png'} />
              </Link>
            </div>
          </div>
        )
